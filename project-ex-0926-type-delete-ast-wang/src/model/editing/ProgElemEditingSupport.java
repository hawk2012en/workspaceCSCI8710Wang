...
import analysis.replace.RenamePackageNameAnalyzer;
import analysis.replace.ReplacePackageNameAnalyzer;
...
public class ProgElemEditingSupport extends EditingSupport {
	...
	protected void setValue(Object element, Object value) {
		...
		//new ReplacePackageNameAnalyzer(p, String.valueOf(value));
		new RenamePackageNameAnalyzer(p, String.valueOf(value));
		p.setPkgName((String.valueOf(value)));
	...
	void refreshViewer() {
		...
		// ParameterizedCommand createCommand = commandService.createCommand(commandId,
		// null);
