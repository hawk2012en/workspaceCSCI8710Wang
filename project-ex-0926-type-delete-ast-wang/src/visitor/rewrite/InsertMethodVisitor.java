...
public class InsertMethodVisitor extends ASTVisitor {
	...
	public InsertMethodVisitor(AST astCUnit, ASTRewrite rewrite) {
		this.astCUnit = astCUnit;
		this.rewrite = rewrite;
	}

	public InsertMethodVisitor(ProgramElement curProgElem, String newMethodName) {
	...
	void addNewMethod(MethodDeclaration node) {
		...
		lrw.insertAfter(newMethodDecl, node, null);
	}
