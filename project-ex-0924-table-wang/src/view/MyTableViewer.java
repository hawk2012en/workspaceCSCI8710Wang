...
public class MyTableViewer {
   public final static String ID = "project-ex-0924-table-wang.partdescriptor.simpletableaddingdeletingwang";
   public final static String POPUPMENU = "project-ex-0924-table-wang.popupmenu.mypopupmenu";
